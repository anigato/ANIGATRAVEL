...
@section('pemesanan')
    ...
    <div id="app3" class="container-fluid">
      <h6 class="text-center font-weight-bold text-warning text-uppercase mb-1">Dibatalkan</h6>
      <div v-if="Konfirmasi">
      ...
      <div v-if="Upload">
        ...
        <div class="form-group row">
          <div class="col-sm-2"><button class="btn btn-info btn-block" type="submit" v-on:click="lihat">Lihat Foto</button></div>

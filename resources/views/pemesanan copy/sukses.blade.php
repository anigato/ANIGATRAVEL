...
@section('pemesanan')
    ...
    <div id="app3" class="container-fluid">
      <h6 class="text-center font-weight-bold text-primary text-uppercase mb-1">Sukses</h6>
      <div v-if="Konfirmasi">
      ...
      <div v-if="Upload">
        ...
        <div class="form-group row">
          <div class="col-sm-2"><a class="btn btn-info btn-block" target="blank" href="{{route('export_pemesanan')}}"><i class="fa fa-print"></i> Cetak</a></div>
          <div class="col-sm-2"><button class="btn btn-success btn-block" v-on:click="lihat">Lihat Foto</button></div>
          <div class="col-sm-2"><button class="btn btn-danger btn-block" v-on:click="konfirmasi">back</button></div>
        </div>
      </div>

    ...
    <div id="app3" class="container-fluid">
      ...
      <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" v-on:submit.prevent="find" method="get">
        <div class="input-group">
          <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Statsiun" aria-label="Search" aria-describedby="basic-addon2" v-model="cari" @keyup="find">
      ...
      <form class="user" method="post" v-on:submit.prevent="create" v-if="baru">
        ...
        <div class="form-group row">
          <div class="col-sm-6 mb-3 mb-sm-0">
            <label for="">Nama Statsiun</label>
            <input required type="text" v-model="nama_tempat" class="form-control form-control-user" placeholder="Nama Statsiun">
      ...
      <button class="btn btn-success btn-user btn-block" v-on:click="buat" v-if="buttonBaru">
        <i class="fas fa-plus"></i> Tambahkan Statsiun Baru
      </button>
      <hr>
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Daftar Statsiun</h6>
        </div>
        <div class="card-body">
...
var app = new Vue({
      ...
      xhttp.onreadystatechange = function(){
        if (this.readyState == 4) {
          ...
          if (this.status == 422) {
            swal({
              title: "Maaf!",
              text: "Statsiun yang anda cari tidak ada!",
              icon: "error",
              button: "OK",
            });
          }
      ...
      xhttp.onreadystatechange = function() {
            if (this.readyState == 4) {
              ...
              if (this.status == 200) {
                ...
                swal({
                  title: "Berhasil!",
                  text: "Anda telah berhasil menambahkan Statsiun baru!",
                  icon: "success",
                  button: "OK",
                });
              }
    ...
    del : function(id_tempat){
      swal({
        title: "Yakin mau hapus Statsiun ini?",
        ...
        if (willDelete) {
          ...
          xhttp.onreadystatechange = function(){
            if (this.readyState == 4) {
              ...
              if (this.status == 200) {
                app.getAll();
                swal("Berhasil! Anda telah menghapus salah satu Statsiun!", {
                  icon: "success",
                });
              }
            }
      ...
      xhttp.onreadystatechange = function(){
        if (this.readyState == 4) {
          ...
          if (this.status == 200) {
            ...
            swal({
              title: "Berhasil!",
              text: "Anda telah berhasil mengubah data Statsiun!",
              icon: "success",
              button: "OK",
            });
          }

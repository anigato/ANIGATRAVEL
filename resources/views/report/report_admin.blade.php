...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <div id="invoice" class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Penjualan Tiket Perbulan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Total Pendapatan Perbulan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                <div class="chart-area">

    ...
    <div id="app3" class="container-fluid">
      ...
      <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" v-on:submit.prevent="find" method="get">
        <div class="input-group">
          <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Rute Kereta" aria-label="Search" aria-describedby="basic-addon2" v-model="cari" @keyup="find">
        ...
        <div class="form-group row">
          <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <select style="border-radius:20px" v-model="rute_awal" class="form-control" searchable="Search here..">
              <option v-for="air in statsiuns" :value="air.id_tempat">@{{air.nama_tempat}} (@{{air.wilayah}})</option>
            </select>
          </div>
          <div class="col-sm-6">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Table Rute Kereta</h6>
        </div>
        <div class="card-body">
    ...
    var app = new Vue({
        ...
        methods : {
          transportasi : function(){
            var url = "{{route('rute_trans_train')}}";
          ...
          statsiun : function(){
            var url = "{{route('rute_for_statsiun')}}";
            ...
            xhttp.onreadystatechange = function(){
              if (this.readyState == 4) {
                ...
                if (this.status == 200) {
                  app.statsiuns = JSON.parse(this.responseText);
                }
              }
            }
            xhttp.open("GET",url, true);
          ...
          find : function(){
            var url = "{{route('rute_search_train')}}";
          ...
          xhttp.onreadystatechange = function(){
            if (this.readyState == 4) {
              ...
              if (this.status == 422) {
                swal({
                  title: "Maaf!",
                  text: "Rute Kereta yang anda cari tidak ada!",
                  icon: "error",
                  button: "OK",
                });
              }
          ...
          xhttp.onreadystatechange = function() {
                if (this.readyState == 4) {
                  ...
                  if (this.status == 200) {
                    ...
                    swal({
                      title: "Berhasil!",
                      text: "Anda telah berhasil menambahkan Rute Kereta baru!",
                      icon: "success",
                      button: "OK",
                    });
                  }
        ...
        del : function(id_rute){
          swal({
            title: "Yakin mau hapus Rute Kereta ini?",
            ...
            if (willDelete) {
              ...
              xhttp.onreadystatechange = function(){
                if (this.readyState == 4) {
                  ...
                  if (this.status == 200) {
                    app.getAll();
                    swal("Berhasil! Anda telah menghapus salah satu Rute Kereta!", {
                      icon: "success",
                    });
                  }
                }
          ...
          xhttp.onreadystatechange = function(){
            if (this.readyState == 4) {
              ...
              if (this.status == 200) {
                ...
                swal({
                  title: "Berhasil!",
                  text: "Anda telah berhasil mengubah data Rute Kereta!",
                  icon: "success",
                  button: "OK",
                });
              }

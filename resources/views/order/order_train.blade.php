@extends('admin.admin')
@section('title','Tiket Kereta')
@section('content')
    <!-- Begin Page Content -->
    <div class="container-fluid" id="app3">
      <h6 class="text-center font-weight-bold text-primary text-uppercase mb-1">Tiket Kereta</h6>
      <form class="user" method="post" v-on:submit.prevent="form_rute_p" v-if="Rute">
        ...
        <button type="submit" class="btn btn-primary btn-user btn-block ">
          <i class="fas fa-search"></i> Cari Pemberangkatan 
        </button>
      </form>

    ...
    <div id="app" class="container-fluid">
      ...
      <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" v-on:submit.prevent="find" method="get">
        <div class="input-group">
          <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Pilot" aria-label="Search" aria-describedby="basic-addon2" v-model="cari" @keyup="find">
      ...
      <button class="btn btn-success btn-user btn-block" v-on:click="buat" v-if="buttonBaru">
        <i class="fas fa-user-plus"></i> Tambah Pilot Baru
      </button>
      <hr>
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Table Pilot</h6>
        </div>
        <div class="card-body">
...
@push('js')
  <script type="text/javascript">
    ...
    var app = new Vue({
        ...
        methods : {
          find : function(){
            var url = "{{route('driver_search_flight')}}";
          ...
          xhttp.onreadystatechange = function(){
            if (this.readyState == 4) {
              ...
              if (this.status == 422) {
                swal({
                  title: "Maaf!",
                  text: "Pilot yang anda cari tidak ada!",
                  icon: "error",
                  button: "OK",
                });
              }
        ...
        getAll : function(){
          var url = "{{route('driver_all_flight')}}";
          var data_token = '?token='+token;
          var data = '';
        ...
        getId : function(){
          var url = "{{route('id_transportasi_flight')}}";
          var data_token = '?token='+token;
          var data = '';
          ...
          xhttp.onreadystatechange = function() {
                ...
                app.errors = {};
                  ...
                  if (this.status == 200) {
                    ...
                    swal({
                      title: "Berhasil!",
                      text: "Anda telah berhasil menambahkan Pilot baru!",
                      icon: "success",
                      button: "OK",
                    });
                  }
        ...
        del : function(id_driver){
          swal({
            title: "Yakin mau hapus Pilot ini?",
            ...
            if (willDelete) {
              ...
              xhttp.onreadystatechange = function(){
                if (this.readyState == 4) {
                  ...
                  if (this.status == 200) {
                    app.getAll();
                    swal("Berhasil! Anda telah menghapus salah satu Pilot!", {
                      icon: "success",
                    });
                  }
                }
          ...
          xhttp.onreadystatechange = function(){
            if (this.readyState == 4) {
              ...
              if (this.status == 200) {
                ...
                swal({
                  title: "Berhasil!",
                  text: "Anda telah berhasil mengubah data Pilot!",
                  icon: "success",
                  button: "OK",
                });
              }

...
@section('pemesanan')
    ...
    <div id="app3" class="container-fluid">
      <h4 class="text-center font-weight-bold text-white text-uppercase mb-1">Sedang Diproses</h4>
      <div v-if="Konfirmasi">
      ...
      <div v-if="Upload">
        ...
        <table v-for="i in totals" class="table table-borderless">
          <tr>
            <td>
              <h6 class="font-weight-bold text-white">Silahkan Cek Lagi! Langsung Ubah Bukti Pembayaran Jika Ada Kesalahan</h6>
            </td>
          </tr>
          <tr>
            <td style="width:45%">
          ...
          <tr>
            <td>
              <form action="{{route('update_foto')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-sm-3"><button style="border-radius:10px;border-color:greenyellow" type="submit" class="btn btn-primary btn-block">Ubah Foto</button></div>
                  <div class="col-sm-3"><button style="border-radius:10px;border-color:lightblue" type="submit" class="btn btn-primary btn-block" v-on:click="lihat">Lihat Foto</button></div>
                  <div class="col-sm-3"><button style="border-radius:10px;border-color:red" v-on:click="konfirmasi" class="btn btn-primary btn-block">Kembali</button></div>
                </div>
              </form>
            </td>
          </tr>
      ...
      <div v-if="Lihat">
        <div class="form-group text-center" v-for="i in confirms">
          <img :src="'/storage/images/'+i.nama_foto" alt="" width="70%" style="border-radius:20px;">
          <div class="form-group"></div>

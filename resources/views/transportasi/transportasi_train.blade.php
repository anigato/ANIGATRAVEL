    ...
    <div id="app3" class="container-fluid">
      ...
      <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" v-on:submit.prevent="find" method="get">
        <div class="input-group">
          <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Kereta" aria-label="Search" aria-describedby="basic-addon2" v-model="cari" @keyup="find">
  ...
  <script type="text/javascript">
    ...
    var app = new Vue({
        ...
        methods : {
          ...
          find : function(){
            var url = "{{route('transportasi_search_train')}}";
        ...
        getAll : function(){
          var url = "{{route('transportasi_all_train')}}";
          var data_token = '?token='+token;
          var data = '';
        ...
        del : function(id_transportasi){
          swal({
            title: "Yakin mau hapus Kereta ini?",
              ...
              app.errors = {};
	            app.status = this.status;
                  ...
                  if (this.status == 200) {
                    ...
                    swal({
                      title: "Berhasil!",
                      text: "Anda telah berhasil menghapus salah satu Kereta!",
                      icon: "success",
                      button: "OK",
                    });
                  }
          ...
          xhttp.onreadystatechange = function(){
            if (this.readyState == 4) {
              ...
              if (this.status == 200) {
                ...
                swal({
                  title: "Berhasil!",
                  text: "Anda telah berhasil mengubah salah satu Kereta!",
                  icon: "success",
                  button: "OK",
                });
              }
